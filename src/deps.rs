...
fn transform(toml: Toml) -> Result<Vec<Dependency>> {
    ...
    for d in deps_metadata {
        ...
        let id = table
            .get("id")
            .with_context(|| "id field is required")?
            .as_str()
        ...
        let version = table
            .get("version")
            .with_context(|| "version field is required")?
            .as_str()
            .with_context(|| "version should be a string")?
            .to_owned();
...
mod tests {
    ...
    #[test]
    #[should_panic(expected = "id field is required")]
    fn transform_metadata_dependency_should_have_an_id() {
        transform(
            toml::from_str(
    ...
    #[test]
    #[should_panic(expected = "id should be a string")]
    fn transform_metadata_dependency_id_should_be_str() {
        transform(
            toml::from_str(
                r#"[[metadata.dependencies]]
                    id = 1"#,
    ...
    fn transform_metadata_dependency_should_have_an_version() {
        transform(
            toml::from_str(
                r#"[[metadata.dependencies]]
                    id = "id"
    ...
    #[test]
    #[should_panic(expected = "version should be a string")]
    fn transform_metadata_dependency_version_should_be_str() {
        transform(
            toml::from_str(
                r#"[[metadata.dependencies]]
                    id = "id"
